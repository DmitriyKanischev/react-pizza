...
const Search = ({searchInput, setSearchInput}) => {
    return ( 
        <div className={styles.root}>
            ...
            <input onChange={e => setSearchInput(e.target.value)} value={searchInput} className={styles.input} placeholder='Поиск пиццы' />
            
            {searchInput && <svg onClick={() => setSearchInput('')} className={styles.close} xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" height="200" id="Layer_1" viewBox="0 0 200 200" width="200">
